...
final as (
    select
        *,
        ...
        HASH(transaction_id, canonical_fund_id, source_investor_id, transaction_date, gross_amount_usd, payment_status, settlement_date, settled_amount_usd, last_modified_date) as record_hash
